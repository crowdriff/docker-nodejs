...
RUN \
    ...
    wget -O - http://nodejs.org/dist/v0.10.38/node-v0.10.38-linux-x64.tar.gz | tar xzf - --strip-components=1 --exclude="README.md" --exclude="LICENSE" --exclude="ChangeLog" -C "/usr/local"; \
    npm install -g npm; \
